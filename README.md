...
**[Play the demo →](https://uwussimo.github.io/ux-laws/)** — tic-tac-toe, built with three words and this skill loaded. [Source](./index.html) · also [chess](https://uwussimo.github.io/ux-laws/examples/chess/) · [what changed, law by law](./examples/README.md)
